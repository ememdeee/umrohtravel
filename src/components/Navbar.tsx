...
import { MessageCircle, Menu, Compass, X } from "lucide-react"
...
export function Navbar() {
  ...
  return (
    <nav className="bg-white shadow-lg" id='navigationBar'>
              ...
              <SheetContent side="right" className="w-full sm:w-[300px] bg-white p-0">
                <div className="flex flex-col h-full">
                  ...
                  <div className="mt-auto p-4">
                    <Button variant="outline" className="w-full flex items-center justify-center space-x-2 border-orange-500 text-orange-700 hover:bg-orange-100">
                      <MessageCircle className="h-4 w-4" />
                      <span>Contact Us</span>
                    </Button>
                  </div>
